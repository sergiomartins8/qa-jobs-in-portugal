...
public class Application {
    ...
    private static final String IF_USEFUL_SHIELD = "https://img.shields.io/static/v1?label=%F0%9F%8C%9F&message=If%20Useful&color=BC4E99";
    ...
    private static final String LINKEDIN_SHIELD = "https://img.shields.io/badge/-sergiomartins8-blue?logo=Linkedin&logoColor=white";
    private static final String LINKEDIN_URL = "https://www.linkedin.com/in/sergiomartins8/";
    ...
    private static StringBuilder fillTop() {
        ...
        sb.append(new Heading(TITLE, Constants.HEADING_TITLE)).append("\n\n")
                .append(new Image("", IF_USEFUL_SHIELD)).append("\n")
                .append(new Image("", STARS_SHIELD)).append("\n")
                .append(new Image("", FORKS_SHIELD)).append("\n")
                .append(new Link(new Image("", LINKEDIN_SHIELD), LINKEDIN_URL)).append("\n\n")
